...
A module for the Foundry VTT dnd5e system. This adds a new `JournalEntryPage` document subtype (`quest-board.quest`), which can be used to write quests for players, or for players to keep track of campaign objectives.
